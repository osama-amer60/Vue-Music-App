...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_variant: "bg-blue-400",
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      (this.comment_in_submission = true),
        ...
        (this.comment_alert_variant = "bg-blue-400"),
      ...
      this.song.comment_count+=1
        ...
        const updateCommentCount = doc(db, "songs", this.$route.params.id);
        await updateDoc(updateCommentCount, {
            comment_count: this.song.comment_count
        });

      (this.comment_in_submission = false),
      (this.comment_alert_variant = "bg-green-400"),
